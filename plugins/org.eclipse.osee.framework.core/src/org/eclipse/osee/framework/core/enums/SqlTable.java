...
public class SqlTable extends NamedBase {
   ...
   public static final SqlColumn OSEE_OAUTH_CLIENT_CREDENTIAL_CLIENT_CERT =
      OSEE_OAUTH_CLIENT_CREDENTIAL_TABLE.addVarCharColumn("CLIENT_CERT", 255, true);
   public static final SqlColumn OSEE_OAUTH_CLIENT_CREDENTIAL_CLIENT_SECRET =
      OSEE_OAUTH_CLIENT_CREDENTIAL_TABLE.addVarCharColumn("CLIENT_SECRET", 255, true);
   ...
   static {
      OSEE_OAUTH_CLIENT_CREDENTIAL_TABLE.setPrimaryKeyConstraint(OSEE_OAUTH_CLIENT_CREDENTIAL_CLIENT_ID);
